...
export function Customers() {
  const {
    ...
    queryKey: [""],
    queryFn: () =>
      axios("/customer/all", {}).then((res) => {
        return res.data;
      }),
  });

  const customerAddMutation = useMutation({
  ...
  const handleAdd = () => {
    ...
    customerAddMutation.mutate(form.values);
  };
                    ...
                    >
                      ...
                      <Group justify="start" mt="xl">
                        <Button
                          ...
                          loading={customerAddMutation.isPending}
                          disabled={customerAddMutation.isPending}
                        >
                          {customerAddMutation.isPending
                            ? "Loading..."
                            : "Save customer"}
                        </Button>
                      </Group>
