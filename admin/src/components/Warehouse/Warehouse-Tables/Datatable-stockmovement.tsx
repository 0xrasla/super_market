...
export function WarehouseStockmovement() {
...
<Table.Tr >
        ...
        <Table.Td className="font-semibold">Vendor Name <br />
        <span className="text-[#4C4C4C9C] font-semibold">Vendor Id - #453435</span> <br />
        <span className="text-[#4C4C4C9C]  ">8870635766</span> <br />
        </Table.Td>
        <Table.Td className="font-semibold">Shop Name <br />
        <span className="text-[#4C4C4C9C] font-semibold">Shop Id - #453435</span> <br />
        <span className="text-[#4C4C4C9C]  ">8870635766</span> <br />
        </Table.Td>
    ...
    <div className="p-8 border-2 border-solid border-gray-200 rounded-md ml-4 mt-4 flex gap-4 w-[97%] items-start">
      <div className="flex flex-col w-full">
        <div className="flex justify-between m-2">  
          <h2 className="capitalize font-medium text-lg">Stock Movement</h2>
        </div>
