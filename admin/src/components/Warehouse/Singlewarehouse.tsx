     ...
     {isLoading ? <div>Loading...</div> :  
      <div className="shadow-lg p-4 border-2 border-solid border-gray-200 rounded-md ml-4 mt-4 w-[55%] items-start">
          <div className="flex justify-between w-full">
            <div className="font-semibold text-[20px]">{warehouseData?.data.name}</div>
          ...
          <div className="flex gap-16">
            ...
            <div className="space-y-3">
              <div className="grid grid-cols-2 gap-24">
                ...
                <div className="font-semibold"> {warehouseData?.data.managername}</div>
              </div>

              <div className="grid grid-cols-2 gap-24">
                <div className="text-[#808080] font-semibold">Email</div>
                <div className="font-semibold">{warehouseData?.data.email} </div>
              </div>
      ...
      <Tabs color="#00B207" className="p-4" variant="pills" radius="xl" defaultValue="Products">
      <Tabs.List>
        <Tabs.Tab value="Products" className="text-[16px] pt-3 pb-3 pl-9 pr-9 font-bold">
          Products
        </Tabs.Tab>
        <Tabs.Tab value="Stockmovement" className="text-[16px] pt-3 pb-3 pl-9 pr-9 font-bold">
        Stock movement
        </Tabs.Tab>
